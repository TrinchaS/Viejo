...
public class JwtTokenProvider {
    ...
    public boolean validarToken(String token) {
        try {
            ...
            throw new PortfolioException(HttpStatus.BAD_REQUEST,"Firma JWT no valida");
        }catch (MalformedJwtException ex) {
            throw new PortfolioException(HttpStatus.BAD_REQUEST,"Token JWT no valida");
            ...
            throw new PortfolioException(HttpStatus.BAD_REQUEST,"La cadena claims JWT esta vacia");
        }
    }
}